; **********************************************************************
; **  Config: Z1 = Z280RC                       by Stephen C Cousins  **
; **  Modifications for Z280RC by Bill Shen <hcs>                     **
; **********************************************************************

; Target hardware
;#DEFINE    Z280RC_Z280         ;Determines hardware support included 
...
kConfMajor: .EQU 'Z'            ;Config: Letter = official, number = user
;kConfMinor: .EQU '1'           ;Config: 1 to 9 = official, 0 = user
...
; Timing
kDelayCnt:  .EQU 498            ;Loop count for 1 ms delay at 12.0 MHz
...
;#DEFINE    IncludeSelftest     ;<hcs> Self test at reset
