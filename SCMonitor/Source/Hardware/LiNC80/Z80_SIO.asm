...
;
; LiNC80 standard addresses for Grant's original SIO/2: (type 1)
...
; LiNC80 type 1 serial SIO/2 initialise
...
LiNC80_SerialSIO2_Initialise_T1:
...
; Device present, so initialise it
            RET                 ;Init later as part of baud rate setting
            ;LD   C,kSIOAConT1  ;SIO/2 channel A control port
            ;CALL LiNC80_SerialSIO2_IniSend
            ;LD   C,kSIOBConT1  ;SIO/2 channel B control port
            ;JP   LiNC80_SerialSIO2_IniSend


; LiNC80 type 1 serial SIO/2 channel A & B input character
;   On entry: No parameters required
;   On exit:  A = Character input from the device
;             NZ flagged if character input
;             BC DE HL IX IY I AF' BC' DE' HL' preserved
LiNC80_SerialSIO2A_InputChar_T1:
            ...
            RET
LiNC80_SerialSIO2B_InputChar_T1:
...
; LiNC80 type 1 serial SIO/2 channel A & B output character
...
;             BC DE HL IX IY I AF' BC' DE' HL' preserved
LiNC80_SerialSIO2A_OutputChar_T1:
            PUSH BC
            ...
            RET
LiNC80_SerialSIO2B_OutputChar_T1:
            PUSH BC
...
; **********************************************************************
; **  End of driver: LiNC80, Serial SIO/2                             **
; **********************************************************************
