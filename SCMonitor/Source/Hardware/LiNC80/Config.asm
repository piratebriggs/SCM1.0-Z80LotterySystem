; **********************************************************************
; **  Config: L* = LiNC80                       by Stephen C Cousins  **
; **********************************************************************

; Target hardware
;#DEFINE    LiNC80_Z80          ;Determines hardware support included 
kHardID:    .EQU 5              ;Hardware ID number

; Build variations:

; Custom build for LiNC80
#IF         BUILD = "L0"
...
kConfMajor: .EQU 'L'            ;Config: Letter = official, number = user
;kConfMinor: .EQU '1'           ;Config: 1 to 9 = official, 0 = user
...
kConDef:    .EQU 2              ;Console device 1 is SIO port A
