; **********************************************************************
; **  Config: W* = SCWorkshop Simulator         by Stephen C Cousins  **
; **********************************************************************

; Target hardware (use #TARGET for simulator otherwise #DEFINE)
...
; Standard build
#IF         BUILD = "W1"
kConfMinor: .EQU '1'            ;Minor config: Any character
...
kConDef:    .EQU 1              ;Console device 1 is simulated terminal
