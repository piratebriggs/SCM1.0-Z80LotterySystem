...
; **  Hardware: SC_S4 (SC111 and compatibles)                         **
; **********************************************************************
...
#INCLUDE    Hardware\SC_S4\Z180Support.asm
...
; Startup message
szStartup:  .DB "RC2014-Z180",kNull
...
@szHardware:
            .DB  "Z180 based RC2014 systems",kNewLine,kNull
