; **********************************************************************
; **  Config: Z2 = Z80SBCRC                     by Stephen C Cousins  **
; **  Modifications for Z80SBCRC by Bill Shen                         **
; **********************************************************************

; Target hardware
;#DEFINE    Z80SBCRC_Z80        ;Determines hardware support included 
...
; Timing
; 7.3728MHz is 306, 22MHz is 913
kDelayCnt:  .EQU 913            ;Loop count for 1 ms delay at 7.3728 MHz
