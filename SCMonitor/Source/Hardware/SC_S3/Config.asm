; **********************************************************************
; **  Config: S3 = SC_S3                        by Stephen C Cousins  **
; **********************************************************************

; Target hardware
;#DEFINE    SC_S3_Z80           ;Determines hardware support included 
...
kBaud1Def:  .EQU 0              ;Console device 1 default baud rate 
kBaud2Def:  .EQU 0              ;Console device 2 default baud rate 
